...
class CategoryViewJobCompleted extends StatefulWidget {
  const CategoryViewJobCompleted({super.key});

  @override
  State<CategoryViewJobCompleted> createState() =>
      _CategoryViewJobCompletedState();
}

class _CategoryViewJobCompletedState extends State<CategoryViewJobCompleted> {
